            ...
            children: [
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                  ...
                                  child: Image(
                                    fit:BoxFit.cover,
                                      image: AssetImage('asset/image/StartPage MrBin.png'))),
                            ],
                          ),
                          Row(
                            ...
                            children: [
                              Container(
                                  ...
                                  child: Image(
                                      fit:BoxFit.cover,
                                      image: AssetImage('asset/image/tECNIMONT_startpage.png'))),
                            ],
                          ),
                        ],
                      ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    GestureDetector(
                      onTap:(){Navigator.push(context, MaterialPageRoute(builder: (context) => EmpLogin(),));
                      },
                      child: Container(
                        height: 45,
                        width: 247,

                        decoration: BoxDecoration(color:app_color2 ,
                            borderRadius: BorderRadius.circular(17.0)),
                        child: Center(
                          child: Text('Waste Collector',
                              style: GoogleFonts.montserrat(
                                  color: app_color,fontSize: 15,fontWeight: FontWeight.w600)),
                        ),
                      ),
                    ),
                    GestureDetector(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => EmpLogin2(),));
